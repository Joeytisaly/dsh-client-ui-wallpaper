window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\SOFT\DeepseekHarness\deepseek-harness-master\packages\client\ui-wallpaper\src\client\WallpaperRow.module.css.mjs
		const css = ".JQ98Ea_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.JQ98Ea_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.JQ98Ea_row{flex-wrap:wrap;align-items:center;gap:12px;display:flex}.JQ98Ea_state{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.JQ98Ea_file{display:none}.JQ98Ea_button{font:inherit;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-floating-fill);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:10px;padding:4px 14px;font-size:14px;line-height:22px}.JQ98Ea_button:hover:not(:disabled){background:var(--dsw-alias-button-floating-hover)}.JQ98Ea_button:disabled{opacity:.5;cursor:default}.JQ98Ea_error{color:var(--dsw-alias-state-error-primary);font-size:13px;line-height:20px}";
		const tagId = "@deepseek-ai/dsh-client-ui-wallpaper/WallpaperRow.module.css";
